...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d',$detail['create_time']);?></div>
        <div class="noticeDetailInfo">联系电话：<?php echo ($detail['tel']); ?></div>
        <h4 class="text-danger">价格:<?php echo ($detail['price']); ?>元/月</h4>
        <div class="noticeDetailContent">
            <img src="<?php echo $picture[$detail['img']];?>" width="200"/>
        </div>
    </div>
</div>
