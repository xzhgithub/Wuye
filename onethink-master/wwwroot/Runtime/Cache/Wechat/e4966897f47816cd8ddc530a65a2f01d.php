...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d',$notice['create_time']);?></div>
        <div class="noticeDetailInfo">活动截止时间：<?php echo date('Y-m-d',$notice['deadline']);?></div>
        <input type="hidden" value="<?php echo ($notice['id']); ?>" id="tex">
        <div class="noticeDetailInfo pull-right"><a class="ajax-get confirm" href="javascript:;">申请参与活动</a></div>
