...
<body>
    ...
    <div class="data-table table-striped">
        <table>
            ...
            <tbody>
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$house): $mod = ($i % 2 );++$i;?><tr>
                        <td><input class="ids" type="checkbox" name="id[]" value="<?php echo ($house["id"]); ?>" /></td>
                        <td><?php echo ($house["id"]); ?></td>
                        <td><a href="<?php echo U('index?pid='.$house['id']);?>"><?php echo ($house["title"]); ?></a></td>
                        <td><?php echo ($house["tel"]); ?></td>
                        <td><?php echo ($house["price"]); ?> <?php echo ($house['company']==0?'元':'万元'); ?></td>
                        <td><?php echo ($house["address"]); ?></td>
                        <td><?php echo ($house["size"]); ?></td>
                        <td><?php echo ($house['type']==1?'出售':'出租'); ?></td>
                        <td><?php echo date('Y-m-d',$house['create_time']);?></td>
                        <td><?php echo ($house["over_time"]); ?></td>
